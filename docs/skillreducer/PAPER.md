...
> Tool schemas: [TSCG PAPER](../tscg/PAPER.md). Quality revision: [SkillRevise PAPER](../skillrevise/PAPER.md). Index: [PAPERS.md](../PAPERS.md).
...
**Optional second paper (not SkillReducer):** Tool / MCP JSON schema compression is **not** from Gao et al. It is wired in separately via `--tscg` — see [TSCG PAPER](../tscg/PAPER.md).
...
*Hands-on:* [BEGINNER.md](BEGINNER.md) · [USAGE.md](USAGE.md) · *All papers:* [../OVERVIEW.md](../OVERVIEW.md)

---

## References (SkillReducer)

- Paper: https://arxiv.org/abs/2603.29919 · [`skill_reducer.pdf`](../../skill_reducer.pdf)
...
*Full academic treatment: [`skill_reducer.pdf`](../../skill_reducer.pdf). BibTeX: [CITATION.md](../../CITATION.md).*
